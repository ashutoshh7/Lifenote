...
/// <summary>
/// Moved from Lifenote.Data/Services/HabitService.cs.
/// Service classes now live in Application layer — they only depend on
/// interfaces (Contracts) and Domain entities, never on EF Core directly.
/// </summary>
